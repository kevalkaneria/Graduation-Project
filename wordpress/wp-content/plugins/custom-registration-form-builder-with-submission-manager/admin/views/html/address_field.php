<?php 
        $city_label= empty($data->model->field_options->field_ca_city_label) ? "City" : $data->model->field_options->field_ca_city_label;
        $state_label= empty($data->model->field_options->field_ca_state_label) ? "State or Region" : $data->model->field_options->field_ca_state_label;
        $zip_label= empty($data->model->field_options->field_ca_zip_label) ? "Zip" : $data->model->field_options->field_ca_zip_label;
        $country_label= empty($data->model->field_options->field_ca_country_label) ? "Country" : $data->model->field_options->field_ca_country_label;
        $address1_label= empty($data->model->field_options->field_ca_address1_label) ? "Address Line 1" : $data->model->field_options->field_ca_address1_label;
        $lmark_label= empty($data->model->field_options->field_ca_lmark_label) ? "Landmark" : $data->model->field_options->field_ca_lmark_label;
        $address2_label= empty($data->model->field_options->field_ca_address2_label) ? "Address Line 2" : $data->model->field_options->field_ca_address2_label;
        ...
        $city_req = isset($data->model->field_options->field_ca_state_req) ? $data->model->field_options->field_ca_state_req : 0;
        ...
        <div id="rm-address-field" >
            <div class="rmrow">
                <div class="rmfield" for="rm_field_is_required_range">
                    <label><b>Address Field Type</b></label>
                </div>
                <div class="rminput">
                    <ul class="rmradio" style="list-style:none;">
                        <li>
                            ...
                            <label for="rm_field_is_ca"><span>Regular</span></label>
                        </li>
                        <li>
                            ...
                            <label for="rm_field_is_ga" class="rm-google-field"><span class="rm-g-field-label">Autocomplete Powered by</span><span class="rm-g-field-img"><img src="'.RM_BASE_URL . "images/rm-google-map-logo.png".'" /></span></label>
                        </li>
                ...
                <div class="rmnote rm-addresstype-note" id="note-ca">
                    ...
                    <div class="rmnotecontent">This will render a normal address section with a group of input boxes for filling in various address details.</div>
                </div>
                
                <div class="rmnote rm-addresstype-note" id="note-ga">
                    <div class="rmprenote"></div>
                    <div class="rmnotecontent">This will allow users to type in their address in a search box and their address will be fetched automatically using Google Maps and entered into appropriate address input boxes.</div>
                </div>
                    ...
                    <div class="rm-address-field-row">
                        <div class="rm-address-field" id="rm-address-field-address">
                            ...
                            <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_address1_req"><input type="checkbox" name="field_ca_address1_req" value="1" '.rm_checkbox_state($address1_req).'>Required</span>
                            </div>
                   ...
                   <div class="rm-address-field-row">
                     ...
                     <label contenteditable="true" spellcheck="false" onkeyup="rm_custom_address_label_changed(this,\'rm_field_ca_address2_label\')">'.$address2_label.'</label>
                           <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_address2_req"><input type="checkbox" name="field_ca_address2_req" value="1" '.rm_checkbox_state($address2_req).'>Required</span>
                            </div>
                     </div>
                   </div>
                   ...
                   <div class="rm-address-field-row">
                     ...
                     <label contenteditable="true" spellcheck="false" onkeyup="rm_custom_address_label_changed(this,\'rm_field_ca_lmark_label\')">'.$lmark_label.'</label>
                           <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_lmark_req"><input type="checkbox" name="field_ca_lmark_req" value="1" '.rm_checkbox_state($lmark_req).'>Required</span>
                            </div>
                     </div>
                   </div>
                    ...
                    <div class="rm-address-field-row rm-address-field-col2" >
                        <div class="rm-address-field" id="rm-address-field-city">
                            ...
                            <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_city_req"><input type="checkbox" name="field_ca_city_req" value="1" '.rm_checkbox_state($city_req).'> Required</span>
                            </div>
                        ...
                        <div class="rm-address-field" id="rm-address-field-states">
                            ...
                            <div id="rm_field_ca_state_all" style="display:none" class="rmstates">
                                ...
                                <div class="rm-ca-actions">
                                    ...
                                    <span id="rm_field_ca_state_req"><input type="checkbox" name="field_ca_state_req" value="1" '.rm_checkbox_state($state_req).'></span> Required
                                </div>
                            </div>    
                            ...
                            <span id="rm_field_ca_state_as_codes" style="display:none"><input name="field_ca_state_codes"   value="1" type="checkbox" '.$state_codes.'/> Show as Codes</span>
                    ...
                    <div class="rm-address-field-row rm-address-field-col2">
                        <div class="rm-address-field" id="rm-address-field-country">
                            ...
                            <select style="display:none" class="form-dropdown ca_country" id="rm_field_ca_country_america" data-component="country" tabindex="-1" disabled=""><option>United States</option></select>
                            <select style="display:none" class="form-dropdown ca_country" id="rm_field_ca_country_america_can" name="field_ca_country_america_can" data-component="country" tabindex="-1"><option value="america">United States</option><option value="america_can">Canada</option></select>
                            ...
                            <div class="rm-ca-actions">
                                ...
                                <span '.$hide_search_opt.' id="field_ca_en_country_search"><input type="checkbox"  name="field_ca_en_country_search" value="1" '.rm_checkbox_state($country_search_enabled).'>Enable Search</span>    
                                <span id="rm_field_ca_country_req"><input type="checkbox" name="field_ca_country_req" value="1" '.rm_checkbox_state($country_req).'>Required</span>
                            </div>
                        ...
                        <div class="rm-address-field" id="rm-address-field-zip">
                            ...
                            <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_zip_req"><input type="checkbox" name="field_ca_zip_req" value="1" '.rm_checkbox_state($zip_req).'>Required</span>
                            </div>
                        ...
                        <div class="rm-address-field-state">
                            <ul>
                                <li>  
                                    ...
                                    <label for="rm-addr-textbox-state" onclick="rm_state_type_changed(\'all\')">All Countries</label>
                                
                                </li>
                                <li>
                                          <input id="rm_ca_state_america" type="radio" name="ca_state_type" value="america">    
                                          <label for="rm-addr-select-state" onclick="rm_state_type_changed(\'america\')">U.S. States</label>    
                                </li>
                                <li>
                                          <input id="rm_ca_state_america_can" type="radio" name="ca_state_type" value="america_can">    
                                          <label for="rm-addr-select-state" onclick="rm_state_type_changed(\'america_can\')">U.S. States & Canadian Provinces</label>    
                                </li>
                                <li>
                                          <input id="rm_ca_state_limited" type="radio" name="ca_state_type" value="limited">    
                                          <label for="rm-addr-select-state" onclick="rm_state_type_changed(\'limited\')">Limited Countries</label>    
                                </li>
...
<script>
    ...
    function rm_show_state_country_fields(type){ alert
        jQuery(".rmstates").hide();
